...
document.querySelector("#btn-holiday").addEventListener("click",function (){
  for(cont=0;cont<document.querySelectorAll(".holiday").length;cont+=1){
    if(clicado==false){
      document.querySelectorAll(".holiday")[cont].style.backgroundColor="white";
      
    }
    else{
      document.querySelectorAll(".holiday")[cont].style.backgroundColor="rgb(238,238,238)";
      }
...
document.querySelector("#btn-friday").addEventListener("click",function(){
  if(clicado2==false){
    clicado2=true;
    for(cont=0;cont<document.querySelectorAll(".friday").length;cont+=1){
...
for(cont=0;cont<document.querySelectorAll(".day").length;cont+=1){
  document.querySelectorAll(".day")[cont].addEventListener("mouseover",function(){
    this.style.fontSize="30px";
  })
  document.querySelectorAll(".day")[cont].addEventListener("mouseleave",function(){
...
//EXERCÍCIO 9
selected=false;
document.querySelector(".my-tasks").children[2].addEventListener("click",function(){
  if(selected==false){
...
function changeColorDayTask(){
  for(cont=0;cont<document.querySelectorAll(".day").length;cont+=1){
    document.querySelectorAll(".day")[cont].addEventListener("click",function(){
      if(this.style.color!=document.querySelector(".task-selected").style.backgroundColor){
        this.style.color=document.querySelector(".task-selected").style.backgroundColor;
      }else{
